...
TEST(CorrectMatrixMutltiplicationTest, AssociativeMatMult){
    ...
    multiplyMatricesWithoutErrors(A,B,T,A.size(),A[0].size(),B[0].size());
    multiplyMatricesWithoutErrors(T,C,D,T.size(),T[0].size(),C[0].size());
    ...
    multiplyMatricesWithoutErrors(B,C,T,B.size(),B[0].size(),C[0].size());
    multiplyMatricesWithoutErrors(A,T,D,A.size(),A[0].size(),T[0].size());
